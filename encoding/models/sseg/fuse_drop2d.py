...
class FuseNet(nn.Module):
    def __init__(self, img_ch=3, output_ch=1, dropout=None):
        ...
        if self.drop_out:
            ...
            self.dep_drop4 = nn.Dropout2d(p=dropout)
            self.dep_drop5 = nn.Dropout2d(p=dropout)
            self.drop = nn.Dropout2d(p=dropout)
            self.decode_drop5 = nn.Dropout2d(p=dropout)
            self.decode_drop4 = nn.Dropout2d(p=dropout)
            self.decode_drop3 = nn.Dropout2d(p=dropout)
