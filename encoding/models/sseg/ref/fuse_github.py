...
def define_FuseNet(num_labels, rgb_enc=True, depth_enc=True, rgb_dec=True, depth_dec=False, norm='batch',
                   use_dropout=True, init_type='xavier', init_gain=0.02, gpu_ids=[]):
    net = None
